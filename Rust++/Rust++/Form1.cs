    ...
    public partial class Form1 : Form
    {
        ...
        void getData()
        {
            using (WebClient wc = new WebClient())
            {
                ...
                if (Properties.Settings.Default.lastServer != (string)server.data[0].id && bCanChange && bEnabled)
                {
        ...
        {
            this.DesktopLocation = new Point(SystemInformation.VirtualScreen.Width - this.Size.Width);
            timer4.Start();
            timer6.Start();
            this.Visible = false;
        }
